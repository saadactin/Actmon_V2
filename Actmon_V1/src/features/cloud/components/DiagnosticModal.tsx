...
export interface DiagnosticItem {
  /** What this reason is about, e.g. an account name or "Resources". */
  scope: string;
  /** credentials | permission | network | no_data | unknown | never_scanned | scanning | failed | ok */
  category: string;
  message: string;
...
const CATEGORY_META: Record<string, { label: string; Icon: React.ComponentType<{ size?: number; className?: string }>; tone: string }> = {
