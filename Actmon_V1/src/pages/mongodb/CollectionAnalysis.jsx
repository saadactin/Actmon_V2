      ...
      <div style={{ background: `linear-gradient(135deg, ${C.navy} 0%, #0a2d1f 60%, #003d2a 100%)` }} className="text-white px-6 py-5 shadow-2xl">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-black">Collection &amp; Index Analysis</h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            { label: 'Total Docs',  value: fmtNum(totals.docs) },
            { label: 'Data Size',   value: `${totals.sizeMB} MB` },
            { label: 'Index Size',  value: `${totals.idxMB} MB` },
          ].map(k => (
            <div key={k.label} className="rounded-2xl px-4 py-3"
              ...
              <p className="text-2xl font-black mt-0.5" style={{ color: C.green }}>{k.value}</p>
            </div>
          ))}
        </div>
      </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    {filteredColls.slice(0, 200).map((c, i) => {
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-xs">
                    ...
                    <tbody>
                      {filteredIdxs.slice(0, 200).map((idx, i) => (
