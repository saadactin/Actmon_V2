...
export default function SlowQueries() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-900 via-indigo-900 to-violet-800 text-white px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link to={`/postgresql-dashboard/${id}`}
              className="w-9 h-9 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 flex items-center justify-center transition-colors">
              <ArrowLeft size={16} />
            </Link>
            <div>
              <h1 className="text-xl font-black tracking-tight flex items-center gap-2">
                <Zap size={18} className="text-yellow-400" /> PostgreSQL Slow Queries
              </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => refetch()}
              className="flex items-center gap-2 px-4 py-1.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-sm font-semibold transition-colors">
