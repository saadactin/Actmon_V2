...
export default function ErrorLogs() {
  ...
  if (isLoading) return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="text-center">
        ...
        <p className="text-slate-500 text-sm font-semibold">Loading error logs…</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* ── HEADER ─────────────────────────────────────────────── */}
      <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-indigo-900 text-white px-6 py-4 shadow-xl">
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight flex items-center gap-2">
                ...
                Error Logs
                {isFetching && <Loader2 size={13} className="animate-spin text-blue-300 ml-1" />}
              </h1>
              <p className="text-blue-300 text-xs mt-0.5 flex items-center gap-2">
                {source === 'none' || source === 'pg_stat_activity'
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => refetch()}
              className="flex items-center gap-2 px-4 py-1.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-sm font-semibold transition-all">
