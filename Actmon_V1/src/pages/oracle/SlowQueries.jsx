...
export default function SlowQueries() {
  ...
  const queries = data?.slow_queries || data || [];
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-900 via-red-900 to-orange-800 text-white px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight flex items-center gap-2">
                <Zap size={18} className="text-yellow-400" /> Oracle Slow Queries
              </h1>
              <p className="text-orange-300 text-xs mt-0.5">
                Source: V$SQLAREA — top SQL by average elapsed time
              </p>
            </div>
          </div>
