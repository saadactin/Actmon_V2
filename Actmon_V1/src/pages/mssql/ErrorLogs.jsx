...
export default function MSSQLErrorLogs() {
  ...
  return (
    <div className="min-h-full bg-brand-bg">
      ...
      <PageHeader
        icon={FileText}
        title="MSSQL Error Logs"
        subtitle="Severity: FATAL ≥24 · ERROR 16–23 · WARNING 11–15 · INFO <11"
        accent="mssql"
        backTo={`/mssql-dashboard/${id}`}
        crumbs={[{ label: 'Databases', to: '/databases' }, { label: 'SQL Server', to: `/mssql-dashboard/${id}` }, { label: 'Error Logs' }]}
        actions={(
