  ...
  return (
    ...
    >
      ...
      <div className="px-5 pb-4 flex-1 flex flex-col gap-1">
        ...
        {agent.status === 'error' && (
          <span className="text-[10px] text-red-500 font-semibold flex items-center gap-1 cursor-help"
            title={agent.last_error || 'Cannot reach database'}>
            <Info className="h-3 w-3 flex-shrink-0" />
            Cannot reach database — hover for details
          </span>
        )}
      </div>
