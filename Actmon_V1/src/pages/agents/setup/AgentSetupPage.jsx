...
import { X, Zap, Globe, Server, Database, Cloud, Network, Activity, ScrollText, Boxes, Repeat, Gauge, Eye, Plug, Radio, Settings2, FileText } from 'lucide-react';
...
export default function AgentSetupPage() {
  ...
  return (
    <div className="-mx-6 md:-mx-8 -mb-6 md:-mb-8 h-screen bg-white flex flex-col overflow-hidden">
      {/* Header bar */}
      <div className="flex items-center justify-between px-6 py-3.5 border-b border-slate-200 flex-shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-black text-slate-800">Add Data</span>
        </div>
        <button onClick={() => navigate(closeTo)} className="text-slate-400 hover:text-slate-700"><X size={20} /></button>
      </div>
