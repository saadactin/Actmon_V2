...
export const rolePermissionsApi = {
  ...
  // Copy all page permissions from one role to another. mode: 'merge' | 'replace'.
  async clone(payload)  { const r = await client.post('/admin/role-permissions/clone', payload); return r.data; },
};
