...
export const TECHS = [
  { id: 'mysql',      name: 'MySQL',      emoji: '🐬', accent: 'from-orange-400 to-orange-600',
    desc: 'MySQL, AWS Aurora, MariaDB, Percona Server, Google Cloud SQL, Azure DB and AWS RDS are supported.', port: 3306, dashboardRoute: 'mysql-dashboard' },
  { id: 'postgresql', name: 'PostgreSQL', emoji: '🐘', accent: 'from-indigo-400 to-indigo-700',
    desc: 'PostgreSQL, AWS Aurora, Percona Distribution, Google Cloud SQL, Azure DB and AWS RDS are supported.', port: 5432, dashboardRoute: 'postgresql-dashboard' },
  { id: 'mssql',      name: 'SQL Server', emoji: '🖥️', accent: 'from-sky-400 to-sky-700',
    desc: 'SQL Server, AWS RDS, Google Cloud SQL and Azure DB are supported.', port: 1433, dashboardRoute: 'mssql-dashboard' },
  { id: 'oracle',     name: 'Oracle',     emoji: '☀️', accent: 'from-red-400 to-red-600',
    desc: 'Oracle Database (via SID or Service Name) is supported.', port: 1521, dashboardRoute: 'oracle-dashboard' },
  { id: 'mongodb',    name: 'MongoDB',    emoji: '🍃', accent: 'from-emerald-400 to-emerald-700',
    desc: 'MongoDB and MongoDB Atlas are supported.', port: 27017, dashboardRoute: 'mongodb-dashboard' },
  { id: 'clickhouse', name: 'ClickHouse', emoji: '⚡', accent: 'from-yellow-400 to-amber-500',
    desc: 'ClickHouse columnar analytics database is supported.', port: 9000, dashboardRoute: 'clickhouse-dashboard' },
];
